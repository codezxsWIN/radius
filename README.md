...
Run from this directory after installing the local package as below. The suite includes40 frozen fixtures across three required models (120 cases), exact rational values, pair sets, deterministic witnesses and two executions per case. Reports are in conformance/reports/reference. Re-running research validates the frozen protocol hashes before recreating the500 paired synthetic populations.
