...
An identifiability stress test constructs two explicitly assumed completions: nine zero-reach credentials versus nine equally powerful credentials. The reported strict upper-tail rank interval changes without contradicting the reported path. These completions illustrate missing information, not estimates of the actual background population. A tied full-reach population has no uniquely identified most-dangerous credential.
