...
const schema = JSON.parse(readFileSync(new URL('../schema/blastradius-graph-v0.1.schema.json', import.meta.url), 'utf8'));
...
if (process.argv[1] && fileURLToPath(import.meta.url) === resolve(process.argv[1])) {
  process.stdout.write(canonical(fromText(readFileSync(0, 'utf8'))) + '\n');
}